...
import com.example.model.Undangan;
import com.example.uas_p3b.DaftarUndanganFragment;
import com.example.uas_p3b.R;
import com.example.uas_p3b.databinding.ItemListUndanganBinding;
...
public class AdapterUndangan extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        binding.deskripsi.setText(this.undangans.get(position).getDescription());
        binding.organizer.setText(this.undangans.get(position).getOrganizer());
        binding.tanggalEnd.setText(this.undangans.get(position).getEnd_datetime());
        binding.tanggalStart.setText(this.undangans.get(position).getStarted_datetime());
        binding.title.setText(this.undangans.get(position).getTitle());
        if(this.undangans.get(position).isAttending()){
            binding.accept.setVisibility(View.INVISIBLE);
            binding.decline.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    callAPI("https://ifportal.labftis.net/api/v1/appointments/"+undangans.get(position).getId()+"/participants/d4cc8fc1-6be2-4411-92f4-5027a928136c","decline");
                }
            });
            ...
            binding.accept.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    callAPI("https://ifportal.labftis.net/api/v1/appointments/"+undangans.get(position).getId()+"/participants/d4cc8fc1-6be2-4411-92f4-5027a928136c","accept");
                }
            });
