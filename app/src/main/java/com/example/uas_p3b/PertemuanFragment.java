...
import com.example.adapter.AdapterPertemuan;
import com.example.uas_p3b.databinding.PertemuanBinding;
...
public class PertemuanFragment extends Fragment {
    ...
    private PertemuanBinding pertemuanBinding;
    private AdapterPertemuan adapterPertemuan;

    public PertemuanFragment(String token) {
        this.token = token;
    }

    public PertemuanFragment newInstance(String token){
        return new PertemuanFragment(token);
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterPertemuan = new AdapterPertemuan(getActivity(),token);
