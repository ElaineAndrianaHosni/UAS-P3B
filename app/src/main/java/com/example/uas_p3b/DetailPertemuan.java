...
import com.example.uas_p3b.databinding.DetailPertemuanBinding;
...
public class DetailPertemuan extends DialogFragment {
    ...
    public DetailPertemuan(String token) {
        this.token = token;
    }

    public DetailPertemuan newInstance(String token){
        return new DetailPertemuan(token);
    }
    @Nullable
    @Override
